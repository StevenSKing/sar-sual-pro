...
export const profit = (params) => get('api/profit', params);
export const getLogs = (params) => get('api/logs', params);
export const delLogs = (params) => get('api/dlog', params);
export const backLog = (params) => get('api/backLog', params);
export const resetPft = (params) => get('api/resetPft', params);
